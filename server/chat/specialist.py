...
def create_context_details(id: int):
    ...
    if chat.is_ready():
        ...
        chat.add_assistant_log("run_created", "Thinking of context details. Run created: {}".format(response["id"]))
...
async def get_context_details(id: int):
    ...
    try:
        ...
        # if assistant found context details with "product_type"
            ...
            chat.add_assistant_log("context_product_type_found", response_body["product_type"])
